...
**Phase:** Pre-build. Spec complete. No application code written yet.
**Next step:** Phase 0 — verify `rusqlite bundled-full` compiles on Windows MSVC, then scaffold the project.
**Spec files:** `HawkwardJournalAI_MASTER_SPEC_v1.6.md` + `HawkwardJournalAI_SPEC_ADDENDUM_v1.7.md`
...
project plan: 
PersonalLifeOS_MASTER_SPEC_v1.6
PersonalLifeOS_SPEC_ADDENDUM_v1.7
